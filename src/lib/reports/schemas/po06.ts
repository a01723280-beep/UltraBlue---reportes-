...
export const po06: ReportDef = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Inspección de la pipa externa",
      fields: [
        {
          // La pipa es de un transportista, no de la planta: antes de cargar
          // hay que dejar constancia de en qué condiciones llegó, porque el
          // producto sale bien de aquí pero viaja en una unidad ajena.
          id: "pipaPropiaOExterna",
          label: "¿La pipa es propia o externa?",
          type: "select",
          options: [
        ...
        { id: "certificadoVigente", label: "¿El certificado del tanque está vigente?", type: "boolean", required: true },
        {
          ...
          label: "Fecha de la última inspección de la unidad",
          type: "date",
        },
        { id: "selloLlegadaIntegro", label: "¿El sello llegó íntegro?", type: "boolean", required: true },
        {
          id: "productoAnterior",
          label: "¿Qué transportó la unidad antes?",
          type: "text",
          help: "Para descartar riesgo de contaminación cruzada.",
          showIf: (v) => v.pipaPropiaOExterna === "Externa",
          required: true,
        },
        {
          id: "pipaAceptada",
          label: "¿Se acepta la unidad para cargar?",
          type: "boolean",
          required: true,
        },
        {
          id: "motivoNoAceptada",
          label: "Motivo por el que no se acepta",
          type: "textarea",
          showIf: (v) => v.pipaAceptada === false,
          required: true,
        },
